...
if (i%2==1) {
	$(".backgroundColor").append("<div class='add white'><div class='shops '><div class='shopx'><div class='shopname text32 pin'>"+data[k][i].shopName+"</div><div class='address pin f18'>"+data[k][i].shopaddress+"</div><div class='time pin f18'>"+data[k][i].shoptime+"</div><div class='num pin f18'>"+data[k][i].shopnum+"</div></div><div class='map'><iframe width='100%' height='100%' frameborder='0' scrolling='no' marginheight='0' marginwidth='0' src='"+data[k][i].mapd+"'></iframe></div><div class='clear clearfix'></div></div></div>");
}else{$(".backgroundColor").append("<div class='add'><div class='shops'><div class='shopx'><div class='shopname text32 pin'>"+data[k][i].shopName+"</div><div class='address pin f18'>"+data[k][i].shopaddress+"</div><div class='time pin f18'>"+data[k][i].shoptime+"</div><div class='num pin f18'>"+data[k][i].shopnum+"</div></div><div class='map'><iframe width='100%' height='100%' frameborder='0' scrolling='no' marginheight='0' marginwidth='0' src='"+data[k][i].mapd+"'></iframe></div><div class='clear clearfix'></div></div></div>");};
