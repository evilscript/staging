...
// 储存店面信息  json
	...
	var data = 
     {"DC Maryland and Virginia":[{"shopName":"Rockville",
			   ...
			   {"shopName":"Falls Church",
				...
				'pic':[{'str':"../shared/images/support/shop1.jpg"},{'str':'../shared/images/support/shop3.jpg'},{"str":'../shared/images/support/shop4.jpg'}]
	...
	"South California":[
			...
			{"shopName":"San Gabriel",
				...
				"shoptime":"Hours: Mon-Sun, 11:00 am-7:30 pm",
	...
	"New York":[
			   ...
			   "shoptime":"Hours: Mon-Sun, 9:30 am-20:30 pm",
	...
	"Texas":[
			   ...
			   "shoptime":"Hours: Fri-Sun, 10:30 am-7:30 pm",
			   "shopnum":"Tel: (832) 203-6006",
...
function all(){
 		...
 		for (i=0; i<as1; i++) {
 			var sp1 ="<div class='add'><div class='shops '><div class='shopx'><div class='shopname title30 mTitle38'>"+data['DC Maryland and Virginia'][i].shopName+"</div><div class='address text18 mTitle26'>"+data['DC Maryland and Virginia'][i].shopaddress+"</div><div class='time text18 mTitle26'>"+data['DC Maryland and Virginia'][i].shoptime+"</div><div class='num text18 mTitle26'>"+data['DC Maryland and Virginia'][i].shopnum+"</div><div class='pic'></div></div><div class='map'><iframe width='100%' height='100%' frameborder='0' scrolling='no' marginheight='0' marginwidth='0' src='"+data['DC Maryland and Virginia'][i].mapd+"'></iframe></div><div class='clear clearfix'></div></div></div>";
 	 	...
 	 	for (nn=0; nn<as6; nn++) {
 	 		var sp6 ="<div class='add '><div class='shops '><div class='shopx'><div class='shopname title30 mTitle38'>"+data['Georgia'][nn].shopName+"</div><div class='address text18 mTitle26'>"+data['Georgia'][nn].shopaddress+"</div><div class='time text18 mTitle26'>"+data['Georgia'][nn].shoptime+"</div><div class='num text18 mTitle26'>"+data['Georgia'][nn].shopnum+"</div><div class='pic'></div></div><div class='map'><iframe width='100%' height='100%' frameborder='0' scrolling='no' marginheight='0' marginwidth='0' src='"+data['Georgia'][nn].mapd+"'></iframe></div><div class='clear clearfix'></div></div></div>";
 		...
 		for (ll=0; ll<as4; ll++) {
 	 		var sp4 ="<div class='add '><div class='shops '><div class='shopx'><div class='shopname title30 mTitle38'>"+data['New York'][ll].shopName+"</div><div class='address text18 mTitle26'>"+data['New York'][ll].shopaddress+"</div><div class='time text18 mTitle26'>"+data['New York'][ll].shoptime+"</div><div class='num text18 mTitle26'>"+data['New York'][ll].shopnum+"</div><div class='pic'></div></div><div class='map'><iframe width='100%' height='100%' frameborder='0' scrolling='no' marginheight='0' marginwidth='0' src='"+data['New York'][ll].mapd+"'></iframe></div><div class='clear clearfix'></div></div></div>";
 		...
 		for (kk=0; kk<as3; kk++) {
 	 	...
 	 	for (j=0; j<as2; j++) {
 	 		var sp2 ="<div class='add'><div class='shops '><div class='shopx'><div class='shopname title30 mTitle38'>"+data['South California'][j].shopName+"</div><div class='address text18 mTitle26'>"+data['South California'][j].shopaddress+"</div><div class='time text18 mTitle26'>"+data['South California'][j].shoptime+"</div><div class='num text18 mTitle26'>"+data['South California'][j].shopnum+"</div><div class='pic'></div></div><div class='map'><iframe width='100%' height='100%' frameborder='0' scrolling='no' marginheight='0' marginwidth='0' src='"+data['South California'][j].mapd+"'></iframe></div><div class='clear clearfix'></div></div></div>";
 		...
 		for (mm=0; mm<as5; mm++) {
 	 		var sp5 ="<div class='add '><div class='shops '><div class='shopx'><div class='shopname title30 mTitle38'>"+data['Texas'][mm].shopName+"</div><div class='address text18 mTitle26'>"+data['Texas'][mm].shopaddress+"</div><div class='time text18 mTitle26'>"+data['New York'][mm].shoptime+"</div><div class='num text18 mTitle26'>"+data['Texas'][mm].shopnum+"</div><div class='pic'></div></div><div class='map'><iframe width='100%' height='100%' frameborder='0' scrolling='no' marginheight='0' marginwidth='0' src='"+data['Texas'][mm].mapd+"'></iframe></div><div class='clear clearfix'></div></div></div>";
...
// 获取value值 半显示
 $("#sel").bind('input propertychange',function(){
 		...
 		if(k=='all'){
 			...
 			for ( i=0;i<l;i++){
			var sp ="<div class='add white'><div class='shops '><div class='shopx'><div class='shopname title30 mTitle38'>"+data[k][i].shopName+"</div><div class='address text18 mTitle26'>"+data[k][i].shopaddress+"</div><div class='time text18 mTitle26'>"+data[k][i].shoptime+"</div><div class='num text18 mTitle26'>"+data[k][i].shopnum+"</div><div class='pic'></div></div><div class='map'><iframe width='100%' height='100%' frameborder='0' scrolling='no' marginheight='0' marginwidth='0' src='"+data[k][i].mapd+"'></iframe></div><div class='clear clearfix'></div></div></div>";
			var sps = "<div class='add'><div class='shops'><div class='shopx'><div class='shopname title30 mTitle38'>"+data[k][i].shopName+"</div><div class='address text18 mTitle26'>"+data[k][i].shopaddress+"</div><div class='time text18 mTitle26'>"+data[k][i].shoptime+"</div><div class='num text18 mTitle26'>"+data[k][i].shopnum+"</div><div class='pic'></div></div><div class='map'><iframe width='100%' height='100%' frameborder='0' scrolling='no' marginheight='0' marginwidth='0' src='"+data[k][i].mapd+"'></iframe></div><div class='clear clearfix'></div></div></div>";
			if (i%2==1) {
