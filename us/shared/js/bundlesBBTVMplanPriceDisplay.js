    ...
    var updatePrice = function(isUser, lineNumber){
         if ( isUser == false ){
            if ( lineNumber == 1) {
                ...
                $scope.plan1_int = '44';
                $scope.plan2_int = '74';
                $scope.plan1_tex = '2条手机线+1个电视+1个电话';
                ...
                $scope.plan1_int = '59';
                $scope.plan2_int = '109';
                $scope.plan1_tex = '3条手机线+1个电视+1个电话';
                ...
                $scope.plan1_int = '74';
                $scope.plan2_int = '144';
                $scope.plan1_tex = '4条手机线+1个电视+1个电话';
                ...
                $scope.plan1_int = '89';
                $scope.plan2_int = '179';
                $scope.plan1_tex = '5条手机线+1个电视+1个电话';
                ...
                $scope.plan1_int = '104';
                $scope.plan2_int = '214';
                $scope.plan1_tex = '6条手机线+1个电视+1个电话';
